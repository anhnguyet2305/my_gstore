...
class ShopInMapModel {
  ...
  ShopInMapModel.fromJson(Map<String, dynamic> json) {
    sort = json['NumberTS'];
  ...
  ShopInMapModel.fromJsonLocal(Map<String, dynamic> jsonData) {
  ...
  bool operator ==(Object other) {
    return other is ShopInMapModel && this.iD == other.iD;
  }
}
